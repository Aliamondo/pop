 ...
 * Modified by Aliamondo, 2014 (slight change)
 * 
...
public enum Modifier {
	...
	GATE_CLOSING (0x03fe, BlockGroup.GATE), //Added for clarity
	GATE_ALWAYS_OPEN (0x03ff, BlockGroup.GATE), //Added for clarity
	...
	BUTTON_PRESSED (0x09fe, BlockGroup.EVENT),
	BUTTON_NOT_PRESSED (0x09ff, BlockGroup.EVENT),
